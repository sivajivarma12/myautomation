...
public class Assignment1 {
	...
	public static void main(String[] args) {
        ...
        boolean customerOrderStatus = false;
        System.out.println("Whether a customer has placed an order:"+customerOrderStatus);
		...
		int empCount=500;
		System.out.println("Number of employees in a company:"+empCount);
